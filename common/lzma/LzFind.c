...
static UInt32 GetBlockSize(CMatchFinder *p, UInt32 historySize)
{
  ...
  */
  ...
  // println("\n LzFind_blockSize = %x", blockSize);
  // println("\n LzFind_blockSize = %d", blockSize >> 20);
  return blockSize;
}
...
static void MatchFinder_CheckLimits(CMatchFinder *p)
{
    ...
    */
  {
    ...
    // println("\nMatchFinder_Normalize() subValue == 0x%x", subValue);
